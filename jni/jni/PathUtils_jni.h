...
static ScopedJavaLocalRef<jstring> Java_PathUtils_getDataDirectory(JNIEnv* env,
    jobject appContext) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_PathUtils_clazz);
  jmethodID method_id =
...
static ScopedJavaLocalRef<jstring> Java_PathUtils_getCacheDirectory(JNIEnv* env,
    jobject appContext) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_PathUtils_clazz);
  jmethodID method_id =
...
static ScopedJavaLocalRef<jstring> Java_PathUtils_getDownloadsDirectory(JNIEnv*
    env, jobject appContext) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_PathUtils_clazz);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  g_PathUtils_clazz = reinterpret_cast<jclass>(env->NewGlobalRef(
      base::android::GetUnscopedClass(env, kPathUtilsClassPath)));
  return true;
}
